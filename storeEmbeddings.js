const {openai, supabase} = require("./src/app/utils/config");
...
const resumeContent = [
    ...
    "What are my weaknesses? I am not the greatest at design, such as UI/UX design! I am trying to get better by doing more projects and currently I am getting better by making a website for my cousin's Liquor Store in New York! ",
  ...
  "Have you won a hackathon? Yes First Place! I won the cuHacking Computer Vision Hackathon, check out the project here: https://devpost.com/software/blocker-ghi365 . Our project was a Productivity Chrome Extension that blocks unproductive websites (Tiktok, Video Games, Anime, Reels) using computer vision. My contribution was automating data collection using Selenium to collect over 200 screenshots of websites and I built the model in Tensorflow. Was a super fun experiance with collaboration and learning. ",
  ...
  "When are you available for a CO-OP Term? I am actively searching CO-OP positions for Summer 2025 and Fall 2025. I am availble for 4,8,12 or 16 months! ",
